...
export default async function HomePage() {
  ...
  return (
    <>
      ...
      <div
        id="home-content"
        className="relative z-10 mx-3 -mt-10 flex min-h-svh flex-col justify-center overflow-hidden rounded-[2rem] bg-surface shadow-2xl shadow-ink/10 md:mx-6 md:-mt-14 md:rounded-[3rem]"
      >
