  ...
  return (
    <header className="sticky top-0 z-50 px-3 pt-3 md:px-6 md:pt-4">
      ...
      <div className="mx-auto w-full max-w-7xl">
        <div className="flex h-12 items-center justify-between gap-3 rounded-full border border-border-soft bg-surface/85 pl-5 pr-5 shadow-lg shadow-ink/5 backdrop-blur-md md:h-14 md:pl-6 md:pr-6">
